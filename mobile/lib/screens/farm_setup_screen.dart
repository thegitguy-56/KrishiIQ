    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          TextField(controller: _name, decoration: const InputDecoration(labelText: 'Farm Name', border: OutlineInputBorder())),
          const SizedBox(height: 12),
          TextField(controller: _area, keyboardType: TextInputType.number, decoration: const InputDecoration(labelText: 'Land Area (acres)', border: OutlineInputBorder())),
          const SizedBox(height: 12),
          TextField(controller: _crop, decoration: const InputDecoration(labelText: 'Primary Crop', border: OutlineInputBorder())),
          const SizedBox(height: 12),
          TextField(controller: _soil, decoration: const InputDecoration(labelText: 'Soil Type', border: OutlineInputBorder())),
          const SizedBox(height: 12),
          OutlinedButton.icon(
            onPressed: _useGps,
